...
export function ChatPage() {
  ...
  return <div className="page">
    ...
    {createOpen && <CreateChannelDialog contacts={contacts.data ?? []} classes={classes.data ?? []} canCreateClass={user?.role === "teacher" || user?.role === "school_admin" || user?.role === "superadmin" || user?.role === "admin"} pending={create.isPending} error={create.isError} onClose={() => setCreateOpen(false)} onSubmit={(data) => create.mutate(data)} />}
  </div>;
}
